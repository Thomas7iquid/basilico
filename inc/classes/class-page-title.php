    ...
    class Basilico_Page_Title
    {
        public function get_page_title(){
            ...
            if ($pt_mode == 'bd' && $ptitle_layout > 0 && class_exists('Pxltheme_Core') && is_callable( 'Elementor\Plugin::instance' )) {
                ?>
                <div id="pxl-pagetitle" style="<?php if(!empty($bg_image)){?>background-image:url('<?php echo esc_url($bg_image); ?>');<?php } ?>" class="pxl-pagetitle bg-image layout-el relative <?php echo !empty(esc_attr($custom_class)) ? $custom_class : ''; ?>">
